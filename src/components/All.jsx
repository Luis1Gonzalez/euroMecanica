...
// const { client,cel,mail,reception,promise,delivered,possibleFailure,brand,model,year,km,failure,id } = regist
    return (
        <div className='mt-1 md:mt-0 text-blue-500 md:w-1/2 md:mx-1'>

{register.map((registeres) => (
    <div key={registeres.id} className='mt-1 bg-gray-200 p-2 rounded-xl'>
    ...
    <input type='submit' className='border-2 p-1.5 rounded-lg bg-green-600 shadow-lg w-36' value="Editar" />
    <input type='submit' className='border-2 p-1.5 rounded-lg bg-red-600 shadow-lg w-36' value="Eliminar" />
</div>
