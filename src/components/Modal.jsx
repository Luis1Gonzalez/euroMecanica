...
const Modal = ({ registerDel, setRegisterDel, wrap, setShowModal, showModal, isShowModal, isCloseModal, setCambiazo, cambiazo }) => {
    ...
    return (
        <div className='transform transition-all fixed w-full min-w-[320px] left-0  top-0 ' style={{ visibility: `${showModal}` }}>


            <div className=' bg-blue-800 w-[100%] flex flex-wrap justify-center bg-transparent h-auto'>

                <div className='bg-orange-200 h-auto md:w-2/3'>
